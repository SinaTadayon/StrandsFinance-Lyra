...
export interface SynthetixAdapter extends BaseContract {
  ...
  functions: {
    ...
    "setGlobalsForContract(address,bytes32,bytes32,address,bytes32)"(
      _contractAddress: string,
      _quoteKey: BytesLike,
      _baseKey: BytesLike,
      _rewardAddress: string,
  ...
  "baseKey(address)"(arg0: string, overrides?: CallOverrides): Promise<string>;
  ...
  "quoteKey(address)"(arg0: string, overrides?: CallOverrides): Promise<string>;
