...
export interface ShortPoolHedgerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [PoolHedgerParametersStruct]
  ): string;
  encodeFunctionData(
...
export interface ShortPoolHedger extends BaseContract {
  ...
  functions: {
    ...
    getPoolHedgerSettings(
      ...
      [PoolHedgerParametersStructOutput, BigNumber] & {
        _poolHedgerParams: PoolHedgerParametersStructOutput;
    ...
    setPoolHedgerParams(
      _poolHedgerParams: PoolHedgerParametersStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "setPoolHedgerParams((uint256,uint256))"(
      _poolHedgerParams: PoolHedgerParametersStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
