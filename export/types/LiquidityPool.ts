...
export interface LiquidityPoolInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, ExchangeParamsStruct, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [LiquidityPoolParametersStruct]
  ): string;
  encodeFunctionData(
...
export interface LiquidityPool extends BaseContract {
  ...
  functions: {
    ...
    "boardSettlement(uint256,uint256,uint256,uint256)"(
      insolventSettlements: BigNumberish,
      amountQuoteFreed: BigNumberish,
      amountQuoteReserved: BigNumberish,
      amountBaseFreed: BigNumberish,
    ...
    "freeQuoteCollateralAndSendPremium(uint256,address,uint256,uint256)"(
      amountQuoteFreed: BigNumberish,
      recipient: string,
      totalCost: BigNumberish,
      reservedFee: BigNumberish,
    ...
    "liquidateBaseAndSendPremium(uint256,address,uint256,uint256)"(
      amountBase: BigNumberish,
      recipient: string,
      totalCost: BigNumberish,
      reservedFee: BigNumberish,
    ...
    "lockBase(uint256,(uint256,bytes32,bytes32,uint256,uint256),uint256)"(
      amount: BigNumberish,
      exchangeParams: ExchangeParamsStruct,
      freeLiquidity: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    "reclaimInsolventBase((uint256,bytes32,bytes32,uint256,uint256),uint256)"(
      exchangeParams: ExchangeParamsStruct,
      amountBase: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    "reclaimInsolventQuote(uint256,uint256)"(
      spotPrice: BigNumberish,
      amountQuote: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    "sendSettlementValue(address,uint256)"(
      user: string,
      amount: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    "sendShortPremium(address,uint256,uint256,uint256)"(
      recipient: string,
      premium: BigNumberish,
      freeLiquidity: BigNumberish,
      reservedFee: BigNumberish,
    ...
    setLiquidityPoolParameters(
      _lpParams: LiquidityPoolParametersStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "setLiquidityPoolParameters((uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,address,uint256,uint256,uint256))"(
      _lpParams: LiquidityPoolParametersStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    "transferQuoteToHedge(uint256,uint256)"(
      spotPrice: BigNumberish,
      amount: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    "updateLiquidationInsolvency(uint256)"(
      insolvencyAmountInQuote: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  };
