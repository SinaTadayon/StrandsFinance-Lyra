...
export interface ShortCollateralInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [string, string, BigNumberish, LiquidationFeesStruct]
  ): string;
  encodeFunctionData(
...
export interface ShortCollateral extends BaseContract {
  ...
  functions: {
    ...
    "boardSettlement(uint256,uint256)"(
      amountBase: BigNumberish,
      amountQuote: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    routeLiquidationFunds(
      ...
      liquidationFees: LiquidationFeesStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "routeLiquidationFunds(address,address,uint8,(uint256,uint256,uint256,uint256,uint256,uint256))"(
      trader: string,
      liquidator: string,
      optionType: BigNumberish,
      liquidationFees: LiquidationFeesStruct,
    ...
    "sendBaseCollateral(address,uint256)"(
      recipient: string,
      amount: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    "sendQuoteCollateral(address,uint256)"(
      recipient: string,
      amount: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
